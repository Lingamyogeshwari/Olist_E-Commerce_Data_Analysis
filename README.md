...
- Analyse overall sales and payment trends
 -Measure average delivery time
- Understand customer satisfaction
- Identify high-performing cities, sellers and product categories
...
The datasets were cleaned and prepared using **Excel Power Query** by:

- Validating data types
- Checking for missing values
- Removing duplicate records where applicable
- Correcting data types
- Preparing datasets for SQL analysis and Power BI reporting
...
- Orders with 5-Star Reviews paid using Credit Card
- Average Delivery Time for Pet Shop Orders
- Average Product Price & Payment Value for São Paulo Customers
- Shipping Days vs Customer Review Scores
